...
The current evidence supports only a short, system-specific operational cost and endpoint-qualification description. It does not establish stable optimizer benefit or justify a general solver ranking; any next step is left to the root decision-maker.
