...
out=Path('research/ga_ssw/evidence/rc-s22-water-dimer-principal-gfn2');out.mkdir(exist_ok=False)
...
for name in ('rc_optimization_domain','rc_vc_geometry','rc_geometry','rc_reference','rc_forest','rc_forest_reference','generalized_numerics','surface'):
