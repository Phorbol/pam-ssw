...
import numpy as np
ROOT=Path('/home/gengjianrui/bin/pam-ssw-worktrees/ga-ssw-behavior-parity'); OUT=ROOT/'research/ga_ssw/evidence/xxxii-rc-vc-globalbudget-central-ritz'; SRC=ROOT/'research/ga_ssw/evidence/xxxii-lammps-qualification-table0-ewald12'; TOPO=Path('/home/gengjianrui/bin/pam-ssw-research/ga-ssw-20260909/GA-SSW_examples_run/global_exploration/input-templates/TYPE2-XXXII/mc'); FIX=ROOT/'tests/standalone/fixtures/type2_xxxii.extxyz'; MODEL=ROOT/'research/ga_ssw/evidence/xxxii-stock-charmm-converted'
