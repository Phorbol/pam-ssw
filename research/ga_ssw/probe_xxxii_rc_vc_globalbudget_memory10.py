...
import numpy as np
ROOT=Path('/home/gengjianrui/bin/pam-ssw-worktrees/ga-ssw-behavior-parity'); OUT=ROOT/'research/ga_ssw/evidence/xxxii-rc-vc-globalbudget-memory10'; SRC=ROOT/'research/ga_ssw/evidence/xxxii-lammps-qualification-table0-ewald12'; TOPO=Path('/home/gengjianrui/bin/pam-ssw-research/ga-ssw-20260909/GA-SSW_examples_run/global_exploration/input-templates/TYPE2-XXXII/mc'); FIX=ROOT/'tests/standalone/fixtures/type2_xxxii.extxyz'; MODEL=ROOT/'research/ga_ssw/evidence/xxxii-stock-charmm-converted'
...
def prepare():
 ...
 cfg={'rotation_length':1.,'torsion_length':1.,'strain_length':5.,'width':.6,'rotation_bias':100.,'max_gaussians':12,'temperature_K':300.,'forward_force':.1,'gradient_tol':.005,'fmax':.01,'stress_tol':.001,'max_step':.2,'relax_steps':1498,'fd_step':1e-4,'rotation_hvp':100,'rotation_tol':.02,'pressure':0.,'lbfgs_memory':None}
