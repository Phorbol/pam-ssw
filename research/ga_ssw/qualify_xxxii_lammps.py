...
OUT=Path('research/ga_ssw/evidence/xxxii-lammps-qualification-first');OUT.mkdir(exist_ok=False)
...
def new():return XXXIILammpsCalculator(data_path=MODEL/'lmp.data',input_path=MODEL/'in.simple',model_manifest=MODEL/'manifest.json',reference_atoms=a)
