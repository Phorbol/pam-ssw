...
OUT=SRC/'public-api-replay-original-input';OUT.mkdir(exist_ok=False)
...
top=read_rigid_topology(SRC/'rigidbody',SRC/'blist',natoms=172)
a=unwrap_rigid_molecules(read(SRC/'type2_xxxii.extxyz'),top.bonds).atoms
