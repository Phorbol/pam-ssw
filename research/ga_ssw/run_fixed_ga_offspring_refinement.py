"""TYPE0 per-offspring SSW refinement audit on all five ASE G2 C4H6 isomers.
...
def main():
    ...
    dump(out/'plan.json', dict(systems=list(molecules), seeds=[11, 29], arms=list(arms),
        ...
        scope='Per-offspring SSW refinement lifecycle validation, selected best only; same frozen C4H6 protocol except offspring_steps=1. Shared ordinary temperature150K explicitly retained to isolate lifecycle; not native5x temperature reproduction. No LS advantage or GA efficiency claim'))
