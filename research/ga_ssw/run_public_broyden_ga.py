"""Public GA integration with opt-in Broyden-Euclidean direction solver; bounded, no retuning."""
...
def main():
    ...
    ssw=SSWConfig(width=.1,rotation_bias=None,pre_rotation_hvp=5,max_gaussians=25,temperature_K=150.,fmax=.01,bias_fmax=.1,relax_steps=400,fd_step=1e-4,rotation_hvp=100,rotation_tol=.02,rotation_solver='broyden-euclidean',cluster_frame='direction_only',direction_sampling='global',quench_optimizer='safe-lbfgs-total')
    ...
    for seed in (11,29):
        ...
        class Bounded(ASESurface):
            ...
            def evaluate(self,a):
                ...
                return e,f
        surface=Bounded(TBLite(method='GFN2-xTB',accuracy=.001,verbosity=0)); row=dict(system='bicyclobutane',seed=seed,arm='plain_single_basin_broyden_euclidean')
        fresh=None;checks=[]
        try:
