"""Prepare a bounded public Cartesian-Broyden SSW/LS lifecycle comparison.
...
def main():
    ...
    plan = dict(
        ...
        scope="bounded public Cartesian-Broyden lifecycle comparison; 100 is an outer-step limit, not paper numerical reproduction; no global-minimum or LS-advantage claim",
