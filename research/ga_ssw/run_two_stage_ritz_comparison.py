"""Ritz main-rotation follow-up to the frozen two-stage plane-dimer protocol."""
import argparse
...
def main():
    ...
    plan = dict(cases=list(cases), seeds=[11, 29], arms=['two_stage_ritz'],
        ...
        hypothesis='Follow-up to frozen two-stage-direction-comparison-20260912. Only main rotation solver changes from plane dimer to forward-difference Ritz; presweep, bias law, seeds and search caps unchanged. Replacing fixed100/original anchor by a short unbiased presweep followed by '
        ...
        for seed in plan['seeds']:
            for arm in plan['arms']:
                ...
                def research_direction(work, anchor, **kwargs):
                    ...
                    mode = two_stage_dimer_direction(work, anchor, pre_rotation_hvp=5, main_solver="ritz", **kwargs)
