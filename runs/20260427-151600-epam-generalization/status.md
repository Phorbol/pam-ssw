...
- Added M22 energy trace recording and plotting for SSW/BH/GA best-energy gap versus local relaxations/generation step.
- M22 candidate production LJ config: `max_steps_per_walk=8`, `proposal_relax_steps=80`, `target_uphill_energy=1.2`, rigid-body projection enabled for free non-periodic clusters, L-BFGS-B `gtol=fmax`. On LJ13/LJ38 seeds 0/1 budget 60, SSW mean gaps are LJ13 `0.42739603752985644`, LJ38 `5.471893746304644`; this beats BH LJ38 `7.269735555874135` and GA LJ38 `5.903696103794346` on the same run. LJ55 seeds 0/1 budget 60 also favors SSW: `10.968849326606573` vs BH `17.780370065155097` and GA `14.967247873689018`.
