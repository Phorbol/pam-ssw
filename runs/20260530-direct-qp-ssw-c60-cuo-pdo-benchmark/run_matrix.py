...
def write_summary(rows: list[dict[str, Any]], grouped: list[dict[str, Any]], final: bool) -> None:
    lines = [
        ...
        "- Variants: bias_relax_current, direct_qp_default, direct_qp_strong",
    ...
    for item in grouped:
        lines.append(
            ...
            "mean_force={force:.1f}, mean_dup={dup:.3f}, direct_steps={direct_steps:.1f}, direct_reject={direct_reject:.1f}, wall={wall:.1f}s".format(
                system=item["system"],
...
def main() -> int:
    ...
    parser.add_argument("--variants", default="bias_relax_current,direct_qp_default,direct_qp_strong")
